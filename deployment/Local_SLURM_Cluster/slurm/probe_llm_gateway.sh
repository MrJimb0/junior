...
#
# Some outbound traffic is blocked from the cluster (e.g. SSH on port 22); ordinary
...
#
# Usage:
#   LLM_GATEWAY_ENDPOINT=https://<host>/path bash deployment/Local_SLURM_Cluster/slurm/probe_llm_gateway.sh
#
