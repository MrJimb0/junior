...
#
# Usage:
#     bash deployment/Local_SLURM_Cluster/slurm/failed.sh <job_id>
#     # prints something like: 7,42,91
#     # then:
#     sbatch --array="$(bash deployment/Local_SLURM_Cluster/slurm/failed.sh 12345)" --export=ALL,CFG=... deployment/Local_SLURM_Cluster/slurm/embed.sh
