...
#
#   cd "$JR_CODE_ROOT" && mkdir -p logs && sbatch --export=ALL,CFG=deployment/NeroGCP/slurm/ingest_override.yaml,PATIENT_LIST=<YOUR_CODE_ROOT>/patient_ids.txt \
#          --array=1-500%20 deployment/NeroGCP/slurm/ingest.sh
#
